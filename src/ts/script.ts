import { buildings, Building } from './data';
import { shuffleArray, getFilteredBuildings, getRandomIndex } from './utils';

// DOM Elements
const mainHtml = document.getElementById('mainHtml') as HTMLElement;
const filteringOptions = document.getElementById(
  'filtering-options'
) as HTMLDivElement;
const sortingOptions = document.getElementById(
  'sorting-options'
) as HTMLDivElement;
const btnRandomBuilding = document.getElementById(
  'random-building'
) as HTMLButtonElement;
const btnResetGallery = document.getElementById(
  'reset-gallery'
) as HTMLButtonElement;
...
const createBuildingCards = (buildings: Building[]): void => {
  mainHtml.innerHTML = '';
...
const resetGallery = (): void => createBuildingCards(buildings);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function handleFilter(): Building[] | undefined {
    // Filter
