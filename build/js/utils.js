...
export const getFilteredBuildings = (buildings, country, architect) => {
    ...
    if (country !== '') {
        filteredBuildings = filteredBuildings.filter((building) => building.country === country);
    }
    if (architect !== '') {
        filteredBuildings = filteredBuildings.filter((building) => building.architect === architect);
    }
